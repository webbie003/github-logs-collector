...
| **Specific image:** `docker pull ghcr.io/webbie003/github-logs-collector:0.2.3` | **Specific image:** `docker pull techie003/github-logs-collector:0.2.3` |
...
|---|---|---|
| `COLLECTOR_VERSION` | Container image version | `0.2.3` |
